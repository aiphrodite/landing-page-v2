...
* Streamlining the creative process (up to 10x faster)
* Number of won contracts (not enough data for a hypothesis yet)
* Fewer meetings between Individual Contributors and Leadership (up to 40 hours saved per campaign)
* Time saved in shortening the approval process (up to 10 hours saved per campaign)
