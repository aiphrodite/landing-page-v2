            ...
            <div className="max-w-sm md:max-w-2xl xl:max-w-none mx-auto grid gap-8 md:grid-cols-2 xl:grid-cols-4 xl:gap-6 items-start">
              ...
              <div className="relative flex flex-col h-full py-5 px-6 rounded bg-white shadow-xl" data-aos="zoom-y-out" data-aos-delay="450">
                ...
                <div className="border-t border-gray-200 pt-5 mt-6">
                  <a className="btn-sm text-white bg-aip-purple-finn hover:bg-aip-purple-royal w-full" href="#0">Request a free trial</a>
                </div>
              </div>
              ...
              <div className="relative flex flex-col h-full py-5 px-6 rounded bg-aip-purple-pale shadow-xl border-2 border-aip-purple-dark" data-aos="zoom-y-out" data-aos-delay="450">
                ...
                <div className="mb-4">
                  <div className="text-lg font-bold mb-1">Business</div>
                  <div className="inline-flex items-baseline mb-2">
                    <span className="text-3xl font-bold">$</span>
