export default function PopularPosts() {
  return (
    <div className="mb-8">
      <h4 className="text-lg font-bold leading-snug tracking-tight mb-4">Popular</h4>
      <ul className="-my-2">
        <li className="flex py-2 border-b border-gray-200">
          ...
          <article>
            <h3 className="font-medium mb-1">
              <a href="/blog/creating-the-most-ineffective-marketing-campaign" className="hover:underline">
                Creating The Most INEFFECTIVE Marketing Campaign, in 5 steps
              </a>
            </h3>
            <div className="text-sm text-gray-800">
              <span className="text-gray-600">By </span>
              <a className="font-medium hover:underline" href="/blog/creating-the-most-ineffective-marketing-campaign">Will Song</a>
            </div>
          </article>
        </li>
      </ul>
